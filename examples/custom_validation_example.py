...
class FinancialInstrument:
    ...
    class Variants:
        ...
        full_analysis = ['symbol', 'name', 'current_price', 'volatility', 'beta', 
                        'pe_ratio', 'volume', 'market_cap', 'last_updated']
...
def main():
    ...
    try:
        ...
        # Test custom methods
        print(f"\n=== Custom Methods ===")
        print(f"Position value (1000 shares): ${instrument.calculate_position_value(1000):,.2f}")
        ...
        print(f"Has custom methods: {hasattr(trading_view, 'calculate_position_value')}")

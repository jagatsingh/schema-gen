...
def enrich_product_data(products_table):
    ...
    class Variants:
        ...
        # Admin variants
        admin_response = ['id', 'name', 'price', 'category', 'stock_quantity', 'is_active', 'created_at']
...
def main():
    ...
    print(f"Target-specific schema custom code keys: {list(target_schema.custom_code.keys())}")

...
class JsonSchemaGenerator:
    ...
    def generate_file(self, schema: USRSchema) -> str:
        ...
        base_schema = self._generate_schema_definition(schema.name, schema.description, base_fields)
        ...
        for variant_name in schema.variants.keys():
            ...
            variant_schema = self._generate_schema_definition(variant_title, schema.description, variant_fields)
    ...
    def _generate_schema_definition(self, title: str, description: str, fields: List[USRField]) -> Dict[str, Any]:
    ...
    def _add_validation_constraints(self, field: USRField, field_schema: Dict[str, Any]):

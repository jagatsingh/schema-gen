...
class KotlinGenerator:
    ...
    def generate_file(self, schema: USRSchema) -> str:
        ...
        base_class = self._generate_single_data_class(schema.name, schema.description, schema.fields, is_base_class=True)
        ...
        for variant_name in schema.variants.keys():
            ...
            variant_class = self._generate_single_data_class(variant_class_name, schema.description, variant_fields)
            lines.append(variant_class)
            lines.append('')
        
        return '\n'.join(lines).rstrip() + '\n'
    
    def _generate_single_data_class(self, class_name: str, description: str, 
